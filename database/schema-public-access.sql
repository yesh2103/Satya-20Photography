-- Satya Photography Database Schema - Public Access Version
-- This version allows public contact form submissions
...
-- Contact form submissions policies - NOW PUBLIC ACCESS
...
-- Packages policies - NOW PUBLIC ACCESS  
...
INSERT INTO users (name, email, role) 
SELECT 'John Doe', 'john@example.com', 'user'
WHERE NOT EXISTS (
